...
<template>
  <aside
    ...
    class="stellar-glass rtl:border-l ltr:border-r border-n-weak flex flex-col text-sm pb-1 fixed top-0 ltr:left-0 rtl:right-0 h-full z-40 transition-transform duration-200 ease-in-out md:static w-[200px] basis-[200px] md:flex-shrink-0 md:ltr:translate-x-0 md:rtl:-translate-x-0"
    :class="[
      {
...
.stellar-glass {
  ...
  background-color: rgba(0, 0, 26, 0.9) !important;
}

// Target active elements deep inside child components
:deep(.text-n-blue-text) {
  @include stellar-active-glow;
}
