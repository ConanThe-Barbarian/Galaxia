# STELLAR SYNTEC CUSTOM BUILD
# Based on official Chatwoot Dockerfile
...
# Optimized memory for asset compilation
...
# This step ensures our custom SCSS and Vue files are compiled into the assets
RUN if [ "$RAILS_ENV" = "production" ]; then \
...
# Remove unnecessary files to slim down image
